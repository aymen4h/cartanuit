function select3(dt3){
    ...
    setTimeout(() => {
    dt3.removeChild(document.getElementById("ma92"));
    ...
    if(T2.length > 0){
        if(TV % 10 > 0 && (TV % 10 - 1) == (T2[T2.length - 1] % 10)){
